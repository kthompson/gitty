...
{
    [TestFixture]
    class IndexTests : TestBase
    {

        [Test]
        public void IndexHasValidHeader()
        {
            var index = new Index(Path.Combine(ArtifactsPath, "index"));
        ...
        {
            var index = new Index(Path.Combine(ObjectsPath, "blobs", "0f4a22329fb3970ca4c19d873623c68e937ba16c"));
            //force load
